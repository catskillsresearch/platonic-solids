...
\caption{Top-level Lean module graph. $\mathtt{CellularHomology}$ packages finite $2$-complexes and transports Betti finranks through quasi-isomorphisms; singular topology and cellular Euler--Poincar\'e meet in the optional $3$D bridge. The Gram-matrix stack feeds the $4$D classification.}
\label{fig:lean}
\end{figure}
...
| `PlatonicSolids/CellularHomology.lean` | §2.1 | Categorical finite $2$-complex; Betti finranks; quasi-isomorphism transport |
