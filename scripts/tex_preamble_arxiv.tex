...
% Adapted from lrsodincic/scripts/tex_preamble_arxiv.tex for the PlatonicSolids
% PDF pipeline (listings literate table + unicode declarations).
...
% Long inlined Lean listings can exhaust pdfTeX main memory; build with
% LuaLaTeX (see .latexmkrc).
%
...
% its native notation (∀ ◇ □ ⟶ ⊢ φ ψ Γ …).  Every non-ASCII glyph that occurs in the
% sources must appear in this table.
